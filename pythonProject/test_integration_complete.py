...
def test_sinpe_transfer_payload():
    ...
    payload = {
        ...
        "amount": {"value": amount, "currency": "CRC"},
    ...
    print("✓ SINPE transfer payload created")
...
def test_sinpe_movil_payload():
    ...
    payload = {
        ...
        "receiver": {"phone_number": receiver_phone},
        "amount": {"value": amount, "currency": "CRC"},
    ...
    print("✓ SINPE Móvil transfer payload created")
    print(f"  Transaction ID: {transaction_id}")
...
def test_bank_communication_simulation():
    ...
    try:
        ...
        for bank in active_banks[:3]:  # Test first 3
            ip_port = bank["IP"]
            print(
                f"    → {bank['contacto']} ({ip_port}): Connection would be attempted"
            )
