...
class BankConnectorService:
    def __init__(self):
        self.contactos_file = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'contactos-bancos.json')
        self.iban_structure_file = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'IBAN-estructure.json')
    ...
    def send_sinpe_transfer_to_bank(self, target_iban: str, transfer_data: Dict) -> Dict:
        """
    ...
    def send_sinpe_movil_transfer_to_bank(self, target_phone: str, transfer_data: Dict) -> Dict:
        """
