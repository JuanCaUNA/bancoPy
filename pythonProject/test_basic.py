...
def test_hmac_logic():
    ...
    try:
        ...
        hmac_result = generar_hmac_test(test_account, test_timestamp, test_transaction_id, test_amount)
        
        print(f"✓ HMAC generation test passed")
