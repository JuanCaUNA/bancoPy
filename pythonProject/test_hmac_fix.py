...
def generate_hmac_corrected(account_number, timestamp, transaction_id, amount, secret="supersecreta123"):
...
def generate_hmac_old(account_number, timestamp, transaction_id, amount, secret="supersecreta123"):
...
def main():
    ...
    print(f"  Mensaje: {account + timestamp + transaction_id + '{:.2f}'.format(amount)}")
