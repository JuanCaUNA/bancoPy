...
def test_payload_structures():
    ...
    try:
        ...
        sinpe_payload = {
            ...
            "amount": {"value": 15000.0, "currency": "CRC"},
        ...
        print(
            f"  Amount: {sinpe_payload['amount']['value']} {sinpe_payload['amount']['currency']}"
        )
        ...
        sinpe_movil_payload = {
            ...
            "amount": {"value": 5000.0, "currency": "CRC"},
        ...
        print(
            f"  Amount: {sinpe_movil_payload['amount']['value']} {sinpe_movil_payload['amount']['currency']}"
        )
